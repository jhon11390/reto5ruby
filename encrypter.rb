class Encrypter
    ...
    def createquestion
        File.write("./Preguntas/pregunta#{@numberfiles}.txt", "#{@question}\n#{answer}")
    end
end
...
definicionencry = encriptado(definicion)
respuestaencry = encriptado(respuesta)

filecrypte = Encrypter.new(definicionencry, respuestaencry)
filecrypte.createquestion